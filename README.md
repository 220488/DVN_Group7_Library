...
Built for **36104 Data Visualisation** — Assignment 3, UTS.

---

## Project Overview

This project visualises ABS CPI data to help [Persona: input after confirming] understand inflation patterns [What we really want to spread: input after confirming] across Australia's eight capital cities and twelve expenditure categories.
...
Australian Bureau of Statistics. (2026). _Consumer Price Index, Australia, February 2026_ (Cat. No. 6401.0). ABS. https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation/consumer-price-index-australia/latest-release
